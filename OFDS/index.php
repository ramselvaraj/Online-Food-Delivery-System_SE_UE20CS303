...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" height = "45" width = "166" src="images/ofds.png" alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/bruh2.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white" style = "font: Monsterrat;">
                    ...
                    <div class ="steps" style = "font-size: 25px;" >
                        <div style = "color:gray">A Project by </div> Ram Selvaraj | Shafiudeen Kameel |  Riya Hurtis | Sagarikha M 
                        </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Latest Dishes</h2>
                    <p class="lead">Order from the latest available dishes</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">&#x20B9 '.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Cash on Delivery | UPI</p>
                    </div>
                </div>
            </div>
        </section> -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>PES University, Electronic City</p>
                                    <h5>Phone: 9448069774</a></h5> </div>
