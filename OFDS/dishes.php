        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" height = "36" width = "136" src="images/ofds.png" alt=""> | Online Food Delivery System  </a>
...
?>									
                                        ...
                                        <div class="form-group row no-gutter">
                                            <div class="col-xs-8">
                                                 <input type="text" class="form-control b-r-0" value=<?php echo "&#x20B9 ".$item["price"]; ?> readonly id="exampleSelect1">
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>TOTAL</p>
                                        <h3 class="value"><strong><?php echo "&#x20B9 ".$item_total; ?></strong></h3>
                                        <p>Free Delivery!</p>
                                        <?php
                                        if($item_total==0){
                                        ?>
						...
						<?php  
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >&#x20B9 <?php echo $product['price']; ?></span>
